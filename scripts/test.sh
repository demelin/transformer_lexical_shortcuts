...
python $transformer_home/codebase/nmt.py \
    ...
    --use_sacrebleu \
    --validate_only \
    --reload $run_dir/transformer.npz-152000 $run_dir/transformer.npz-148000 $run_dir/transformer.npz-144000 $run_dir/transformer.npz-140000 $run_dir/transformer.npz-136000
