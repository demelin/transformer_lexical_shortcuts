...
from fairseq.modules import LayerNorm, \
    MultiheadAttention, ShortcutMultiheadAttention, ShortcutMultiheadAttentionWithFusion
from fairseq.modules.fairseq_dropout import FairseqDropout
from fairseq.modules.quant_noise import quant_noise


# NOTE: Shortcut attention is ONLY utilized in self-attention as that was found to be most effective
# NOTE: Layer normalization is not applied in Shortcut Transformer
...
class ShortcutTransformerEncoderLayer(nn.Module):
    """Encoder layer block. Augmented with additional gated shortcuts.
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def build_self_attention(self, embed_dim, cfg):
        attention_fn = \
            ShortcutMultiheadAttention if not cfg.use_feature_fusion else ShortcutMultiheadAttentionWithFusion
        return attention_fn(
            embed_dim,
            cfg.encoder.attention_heads,
            dropout=cfg.attention_dropout,
...
class ShortcutTransformerDecoderLayer(nn.Module):
    """Decoder layer block.
