...
@register_model("shortcut_transformer")
class TransformerModel(ShortcutTransformerModel):
    """
    This is the legacy implementation of the shortcut transformer model that
    uses argparse for configuration.
    """
...
@register_model_architecture("shortcut_transformer", "shortcut_transformer")
def base_architecture(args):
    ...
    args.warmup_updates = getattr(args, "warmup_updates", 8000)

    args.use_feature_fusion = False


@register_model_architecture("shortcut_transformer", "shortcut_transformer_with_feature_fusion")
def base_architecture(args):
    args.use_feature_fusion = True
